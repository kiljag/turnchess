// heartbeart
export const TYPE_HEART_BEAT = 'heart_beat';
...
export const TYPE_PLAYER_IN_ROOM = 'player_in_room';
export const TYPE_BOARD_IS_FULL = 'board_is_full';
export const TYPE_ROOM_IS_FULL = 'room_full';
export const TYPE_PLAYER_DISCONNECTED = 'player_disconneted';
export const TYPE_PLAYER_LEFT = 'player_left';
